...
const statusColor: Record<string, string> = {
  ...
  "AI CORE ACTIVE": "text-primary border-primary/40 bg-primary/5",
  ONLINE: "text-emerald-400 border-emerald-400/40 bg-emerald-400/5",
};
    ...
    <section ref={ref} id="projects" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-12 space-y-6">
          {projects.map((p, i) => (
            <AnimatedCard key={p.id} delay={i * 0.15}>
              <article
                data-cursor="target"
