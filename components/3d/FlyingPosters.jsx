...
export default function FlyingPosters({
    ...
    if (autoScrollSpeed) {
      const drift = () => {
        if (instanceRef.current) {
          instanceRef.current.scroll.target += autoScrollSpeed;
        }
  ...
  useEffect(() => {
    ...
    el.addEventListener('mousedown', handleTouchDown);
    el.addEventListener('mousemove', handleTouchMove);
    el.addEventListener('mouseup', handleTouchUp);
    el.addEventListener('touchstart', handleTouchDown, { passive: true });
    el.addEventListener('touchmove', handleTouchMove, { passive: true });
    el.addEventListener('touchend', handleTouchUp);

    return () => {
      el.removeEventListener('wheel', handleWheel);
      el.removeEventListener('mousedown', handleTouchDown);
      el.removeEventListener('mousemove', handleTouchMove);
      el.removeEventListener('mouseup', handleTouchUp);
      el.removeEventListener('touchstart', handleTouchDown);
      el.removeEventListener('touchmove', handleTouchMove);
      el.removeEventListener('touchend', handleTouchUp);
    };
  }, []);
